...
import stylesCss from 'themes/airmoldova/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_airmoldova_componentCss']) {
    
    document['_vaadintheme_airmoldova_componentCss'] = true;
  }
